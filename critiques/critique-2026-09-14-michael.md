...
- **M8 — §6 lacks case-study method.** "For a week" — which week? How was "1,229" counted — by query, by file, over what window? No instrumentation description, no sampling, no corroboration. For a section billed as the paper's spine, it needs a dated, reproducible method paragraph.
